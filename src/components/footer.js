...
import img1 from "../assets/SIE.jpeg";
import {
  FaMapMarkerAlt,
  FaPhoneAlt,
  FaEnvelope,
      ...
      <div className="container mx-auto px-4 flex flex-col lg:flex-row items-center lg:items-start justify-between gap-8 pb-8 border-b border-[#28274a]">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-4 text-center sm:text-left">
          <img
            src={img1}
            alt="School Logo"
            className=" sm:w-30 md:w-60 object-contain"
          />
          {/* <div>
        ...
        <div className="flex flex-col items-center gap-6 flex-1">
          <div className="flex flex-col sm:flex-row gap-4 sm:gap-8 items-center">
            ...
            <a href="/about_us" className="hover:text-amber-400 transition">
              About
            </a>
            <a href="/news" className="hover:text-amber-400 transition">
              News
            </a>
          ...
          <div className="flex gap-4 mt-2">
            <a
              href="https://www.linkedin.com/company/school-of-innovation-entrepreneurship/"
        ...
        <div className="flex flex-col items-center lg:items-end gap-2 text-center lg:text-right mt-8 lg:mt-0">
          <div className="flex items-center gap-2 text-sm text-gray-300">
            <HiBuildingOffice2 className="text-white" /> 1st Floor, Sudha &
            Shankar Innovation Hub
          </div>
          <div className="flex items-center gap-2 text-sm text-gray-300">
            <FaMapMarkerAlt className="text-white" /> IIT Madras, Chennai - 600
            036
          </div>
          <div className="flex items-center gap-2 text-sm text-gray-300">
            <FaPhoneAlt className="text-white" /> 044 - 2257 8514
          </div>
          <div className="flex items-center gap-2 text-sm text-gray-300">
            <FaEnvelope className="text-white" /> support@sieiitm.org
          </div>
        </div>
      </div>
      {/* Bottom Bar */}
