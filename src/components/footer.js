...
import { FaMapMarkerAlt, FaPhoneAlt, FaEnvelope, FaFacebookF, FaTwitter, FaInstagram, FaYoutube, FaLinkedinIn } from "react-icons/fa";
    ...
    <footer className="bg-[#18172B] text-white pt-10 pb-4 mt-10 border-t border-[#28274a]">
      ...
      <div className="container mx-auto px-4 flex flex-col lg:flex-row items-center lg:items-start justify-between gap-8 pb-8 border-b border-[#28274a]">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-4 text-center sm:text-left">
          <img src={img1} alt="School Logo" className=" sm:w-30 md:w-60 object-contain" />
          {/* <div>
        ...
        <div className="flex flex-col items-center gap-6 flex-1">
          ...
          <div className="flex gap-4 mt-2">
            <a href="https://www.linkedin.com/company/school-of-innovation-entrepreneurship/" className="hover:text-blue-500 transition" aria-label="Facebook"><FaLinkedinIn size={20} /></a>
